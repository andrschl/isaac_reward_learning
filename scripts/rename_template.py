...
if __name__ == "__main__":
    ...
    old_name = "isaac_reward_learning"
    new_name = sys.argv[1]
    ...
    if proceed.lower() == "y":
        ...
        os.rename(
            os.path.join(root_dir_path, "source", "isaac_reward_learning", "IsaacRewardLearning"),
            os.path.join(root_dir_path, "source", "isaac_reward_learning", new_name),
        )
        os.rename(
            os.path.join(root_dir_path, "source", "isaac_reward_learning"), os.path.join(root_dir_path, "source", new_name)
        )
